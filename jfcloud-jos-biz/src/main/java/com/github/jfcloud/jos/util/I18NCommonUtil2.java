...
public class I18NCommonUtil2 {
    ...
    public static void reflect(Class entity, String path, String codePre, String pagePre1, String pagePre2){
        reflectEntity(entity,path,codePre,pagePre1,pagePre2); // 写文件
        clearCache(); // 清空缓存
    }
